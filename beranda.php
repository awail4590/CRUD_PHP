...
<body>
    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Fugiat quae sint deleniti eligendi nobis suscipit ipsa,
        laborum blanditiis perferendis vero similique dolores nostrum culpa accusantium quo autem, necessitatibus in
        neque!</p>
    <div class="kotak_link">
        ...
        <form onclick="return confirm('Apakah anda yakin ingin logout?')" action="" method="POST">
            <button name="btnlogout"
                style="margin-left: 250px; font-weight: bold; background-color: red; border-radius: 5px">
    ...
    <div>
        ...
        <table class="tabel" border="1" cellpadding="5">
            ...
            <tr>
                ...
                <td>
                    <form onclick="return confirm('Apakah anda yakin ingin menghapus data barang ini?')"
                        action="hapus_data.php?id_barang=<?= $data['id_brng']; ?>" method="POST">
                        <button>Hapus</button>
                    </form>
                </td>
            </tr>
